...
public class DatabaseHelper {
    ...
    public void init() {
        database = FirebaseDatabase.getInstance("https://social-app-c6aec-default-rtdb.firebaseio.com/");
        database.setPersistenceEnabled(true);
        storage = FirebaseStorage.getInstance("gs://social-app-c6aec.appspot.com");
